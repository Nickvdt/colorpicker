// De volgende code definieert een aantal klassen en functies in JavaScript
// Elk van deze elementen heeft een specifieke rol in de applicatie
// We zullen elk van hen bekijken en hun doel uitleggen met behulp van commentaar

// Definitie van de klasse ColorCard
class ColorCard {
    id;
    color;
    addToList;
    ...
    constructor(newId, newColor, addToList) {
        ...
        // Maak een li element om de kleuren weer te geven
        ...
        // Voeg de cirkel toe aan het HTML element
    ...
    onHTMLElementClicked = () => {
        ...
        // Verander de titel van de pagina naar de hsl kleur
    ...
    render() {
        // Voeg de ColorList toe aan het lichaam van de pagina
    ...
    generateHue = function(){
        class HSLGenerator {
            ...
            generateHue = function(){ // genereert willekeurige waarde voor Hue
                this.randomHue = Math.floor(Math.random() * (360 - 1) + 1);
        
            }
            generateSaturation = function(){ // genereert willekeurige waarde voor Saturation
                this.randomSaturation = Math.floor(Math.random() * (79 - 11) + 11) + "%";
        
            }
            generateLightness = function(){ // genereert willekeurige waarde voor Lightness
